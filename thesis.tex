...
\tikzset{main node/.style={circle,fill=blue!20,draw,minimum size=1cm,inner
sep=0pt},}
%% ---------------------------------
...
2016}}
\newcommand{\timeend}{\iflanguage{english}{31st May 2016}{31. Mai 2016}}
\newcommand{\submissiontime}{31. Mai 2015}
...
%\printnomenclature \addcontentsline{toc}{chapter}{AbkÃ¼rzungsverzeichnis}
}
}

% Execute this command for index creation, i.e., for abbreviations by the
%nomencl package
...
{\bibliographystyle{alpha}}	% german style
